\chapter{Rheologic constraints on the upper mantle from five years of
...
\caption{Left panels show GPS time series from UNAVCO (black) and the
...
\caption{Near-field coseismic and cumulative postseismic displacements
...
\caption{Displacements resulting from fault slip at lower crustal
...
\caption{Coseismic slip and afterslip inferred by fitting eq.
...
\caption{Inferred coseismic slip and afterslip for our preferred
...
\caption{Trade-off curves used to determine the damping parameters
