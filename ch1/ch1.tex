\chapter{Bias in estimates of lithosphere viscosity from interseismic
deformation}
...
\caption{Schematic of the earthquake cycle model: springs indicate
...
(Auxiliary Figure 4), which indicates the biases are not sensitive to
...
strength (Auxiliary Figure 3A,C).  Conversely, when the
...
(Auxiliary Figure 3D,F). This may be counterintuitive, as one might
