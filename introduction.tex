...
and the mechanisms causing it, we can conceivably improve upon
...
Smith1968}. These studies found elevated rates of ground deformation
following the earthquakes, which then decayed over a timescale of
months to years. This type of transient deformation is referred to as
...
The quantity and quality of geodetic data available today has opened
up a new scientific fontier in the analysis of transient deformation.
...
the first views of postseismic deformation and its time-dependence
...
\citet{Dragert2001} from GNSS data. \citet{Dragert2001} observed an
SSE that produced about 2 cm of thrust slip over about 20 days beneath
...
Cascadia SSEs were thought to be seismically silent until
...
transient strain from SSEs. I verify the accuracy of my detection
method by comparing the inferred geophysical signal to observations of
seismic tremor, which are known to coincide with SSEs.

Chapter 7 is a discussion on BSMs and their ability to record strain
from SSEs. The PBO contains about 80 BSMs; however, the
